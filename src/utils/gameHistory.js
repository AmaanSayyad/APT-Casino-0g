 ...
 * Helper functions for saving and managing game results with VRF details and 0G Network logging
 */
...
export const saveGameResult = async (gameData) => {
  try {
    const {
      ...
      vrfValue,
      clientBetId,
      chainId,  // active chain when the game was played
    } = gameData;
    ...
    const ogLogData = {
      ...
      chainId: chainId || null,  // pass active chain so logger uses correct explorer
      entropyProof: {
