...
export default function GameRoulette() {
  ...
  const RouletteHeader = () => {
    ...
    return (
      <div className="relative text-white px-4 md:px-8 lg:px-20 mb-8 pt-4 md:pt-6 mt-2">
        {/* Background Elements */}
  ...
  const placeBet = useCallback((e, type, ind = 0, newVal = bet, revert = false) => {
    ...
    // Initialize Pyth entropy service for Roulette
    if (!pythEntropyService.isInitialized) {
      ...
      // Entropy via Pyth / API — no local VRF check needed
  ...
  // Entropy path — proof count optional
                ...
                {rollResult >= 0 ? (
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column" }}>
                    <Button
                      ...
                      onClick={lockBet}
                    >
                      {total > 0 ? `Place Bet (${total.toFixed(5)} 0G)` : 'Place Bet (0G)'}
                    </Button>
          ...
          <Grid container spacing={4} sx={{ mb: 7 }}>
            ...
            <Grid xs={12} md={6}>
              ...
              >
                ...
                >
                  European Roulette with a single zero and just no house edge - better odds than traditional casinos. Provably fair and powered by Pyth Entropy and 0G-backed logging.
                </Typography>
