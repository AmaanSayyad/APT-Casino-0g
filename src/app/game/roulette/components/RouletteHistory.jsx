...
import { oracleTxUrl, isRealTxExplorerUrl } from '@/utils/oracleExplorer';
                          ...
                          {bet.entropyProof ? (
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5, alignItems: 'center' }}>
                              ...
                              <Box sx={{ display: 'flex', gap: 0.5 }}>
                                {(isRealTxExplorerUrl(bet.entropyProof.txExplorerUrl) ||
                                  oracleTxUrl(bet.entropyProof.transactionHash)) && (
                                  <Box
                                    onClick={() =>
                                      window.open(
                                        isRealTxExplorerUrl(bet.entropyProof.txExplorerUrl)
                                          ? bet.entropyProof.txExplorerUrl
                                          : oracleTxUrl(bet.entropyProof.transactionHash),
                                        '_blank'
                                      )
                                    }
