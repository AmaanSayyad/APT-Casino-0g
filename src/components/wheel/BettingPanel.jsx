...
const BettingPanel = ({
  ...
  return (
    <div className="bg-[#000000] border border-[#9200E1]/35 rounded-3xl p-4 flex flex-col h-full">
      {/* Balance Display */}
      ...
      <button
        ...
        className={`py-3 mt-4 rounded-lg text-center font-semibold transition-all w-full border-2 ${
          isSpinning || betAmount <= 0 || betAmount > balance || balance <= 0
            ...
            : "bg-gradient-to-r from-[#9200E1] to-[#B75FFF] text-[#FEFEFE] hover:from-[#7a00c2] hover:to-[#a855f7] border-[#D5A3FF]/50 shadow-lg hover:border-[#E3C1FF] hover:shadow-[#9200E1]/20"
        }`}
      >
