  ...
  const steps = [
    {
      ...
      description: 'When you start a game, a randomness request is sent to Pyth Network Entropy. The request includes a custom gas limit and required fee.',
      icon: 'client-seed',
    ...
    },
    {
      ...
      description: 'All randomness requests and results are recorded on-chain so you can verify commitments and outcomes independently.',
      icon: 'calculation',
      code: '// Verify via Pyth Entropy Explorer and your chain explorer\nconsole.log(\'Transaction:\', transactionHash);\nconsole.log(\'Entropy explorer:\', explorerUrl);\nconsole.log(\'Chain tx:\', txExplorerUrl);'
    },
    {
      id: 4,
