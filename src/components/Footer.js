...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "X", url: "https://x.com/AptCasino", icon: "/icons/twitter.svg" },
    ...
    { name: "GitHub", url: "https://github.com/AmaanSayyad/APT-Casino-0g", icon: "/icons/github.svg" },
  ];
  ...
  const paymentMethods = [
    { name: "OG", icon: "/icons/eth.svg" },
    { name: "OG", icon: "/icons/apt.svg" },
  ];
    ...
    <footer id="footer" className="bg-sharp-black text-white pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 px-6">
        ...
        <div className="md:col-span-4">
          <div className="mb-6">
            <BrandWordmark className="block transition-transform hover:scale-105" />
          </div>
          <div className="p-[1px] bg-gradient-to-r from-red-magic/40 to-blue-magic/40 rounded-lg mb-6 hover:from-red-magic hover:to-blue-magic transition-all duration-300">
            <div className="bg-[#120010] rounded-lg p-4">
              <p className="text-white/80 text-sm leading-relaxed">
                APT-Casino is your ultimate destination for 0G Network gaming. Experience transparency, fairness,
                and excitement powered by 0G Network blockchain technology.
              </p>
            </div>
          </div>
