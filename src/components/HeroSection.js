...
export default function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col pt-6 sm:pt-8 md:pt-10 relative w-full px-4 sm:px-10 md:px-20 lg:px-36"
    >
      {showAnnouncement && (
        <div className="w-full max-w-2xl mx-auto bg-gradient-to-r from-red-magic/10 to-blue-magic/10 backdrop-blur-sm p-3 rounded-lg border border-purple-500/20 flex justify-center items-center mb-8 mt-8 sm:mt-6">
          <p className="text-sm text-white text-center">
            ...
            High Roller Tournament starting soon! 10,000 OG prize pool.
          </p>
          <button 
