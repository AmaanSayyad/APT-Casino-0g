...
/**
 * Batch harmonization of user-visible source strings (ruleset A).
 * Targets app/components only; intended for one-off or scheduled copy maintenance.
 */
...
// Patterns to replace (legacy public chain names → 0G branding; technical URLs/ids excluded below)
 ...
 */
function main() {
  console.log('🚀 Harmonization ruleset A (copy cleanup)...\n');
  ...
  console.log('✅ Harmonization ruleset A completed.');
